package ltguide.nijikokun.register.payment;
...
public class Methods {
	...
	private static void _init() {
		addMethod("iConomy", new ltguide.nijikokun.register.payment.methods.iCo6());
		addMethod("iConomy", new ltguide.nijikokun.register.payment.methods.iCo5());
		addMethod("iConomy", new ltguide.nijikokun.register.payment.methods.iCo4());
		addMethod("BOSEconomy", new ltguide.nijikokun.register.payment.methods.BOSE6());
		addMethod("BOSEconomy", new ltguide.nijikokun.register.payment.methods.BOSE7());
		addMethod("Essentials", new ltguide.nijikokun.register.payment.methods.EE17());
		addMethod("Currency", new ltguide.nijikokun.register.payment.methods.MCUR());
